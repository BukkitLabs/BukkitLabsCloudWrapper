...
public class MinecraftServerStopEvent extends Packet implements Cancelable {
    private MinecraftServerFile minecraftServerFile;
    private boolean canceled=false;

    public MinecraftServerStopEvent(@NotNull final MinecraftServerFile minecraftServerFile) {
